...
use commands::git_commands::{
    ...
    git_branches, git_checkout, git_checkout_remote, git_create_branch,
    git_remotes, git_add_remote, git_remove_remote, git_push_upstream,
    git_init, git_pull, git_push, git_fetch, git_fetch_with_passphrase,
