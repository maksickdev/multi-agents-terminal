...
export function ActivityBar() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center w-12 flex-shrink-0 bg-[var(--c-bg)] h-full select-none" style={{ borderRadius: 10, marginTop: 4, marginBottom: 4, marginLeft: 4 }}>
        {/* Top actions */}
