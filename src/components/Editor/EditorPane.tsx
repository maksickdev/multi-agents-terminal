    ...
    <>
      ...
      >
        ...
        {projectFiles.length === 0 ? (
          <>
            <div className="flex items-center px-3 h-8 flex-shrink-0 border-b border-[var(--c-border)]">
              <span className="text-xs font-semibold uppercase tracking-wider text-[var(--c-text-dim)]">Editor</span>
            </div>
