...
const tokyoNightTheme = EditorView.theme({
  ...
  ".cm-panels.cm-panels-top": { position: "absolute", top: "4px", right: "4px", left: "auto", width: "auto", zIndex: "10", borderTop: "none", backgroundColor: "transparent", padding: "0" },
  ".cm-panels": { backgroundColor: "transparent", padding: "0" },
  ".cm-search": { display: "flex", alignItems: "center", flexWrap: "wrap", gap: "2px", padding: "4px 6px", backgroundColor: "#16161e", border: "1px solid #1f2335", borderRadius: "4px", boxShadow: "0 2px 8px rgba(0,0,0,0.4)", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace' },
  ".cm-textfield": { height: "22px", padding: "0 6px", backgroundColor: "#0d0e17", color: "#c0caf5", border: "1px solid #1f2335", borderRadius: "3px", fontSize: "12px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', outline: "none", minWidth: "120px", width: "120px" },
  ".cm-textfield:focus": { borderColor: "#7aa2f7" },
  ".cm-search .cm-button": { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", padding: "0", border: "none", borderRadius: "3px", backgroundColor: "transparent", backgroundImage: "none", color: "#414868", cursor: "pointer", flexShrink: "0" },
  ".cm-search .cm-button:hover": { color: "#7aa2f7", backgroundColor: "#1f2335" },
  ".cm-search label": { display: "inline-flex", alignItems: "center", gap: "3px", fontSize: "11px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', color: "#414868", cursor: "pointer", userSelect: "none" },
  ".cm-search input[type=checkbox]": { accentColor: "#7aa2f7", width: "11px", height: "11px", margin: "0", cursor: "pointer" },
  ".cm-search .cm-search-match-count": { fontSize: "11px", color: "#414868", padding: "0 4px" },
}, { dark: true });
...
const gridMintTheme = EditorView.theme({
  ...
  ".cm-panels.cm-panels-top": { position: "absolute", top: "4px", right: "4px", left: "auto", width: "auto", zIndex: "10", borderTop: "none", backgroundColor: "transparent", padding: "0" },
  ".cm-panels": { backgroundColor: "transparent", padding: "0" },
  ".cm-search": { display: "flex", alignItems: "center", flexWrap: "wrap", gap: "2px", padding: "4px 6px", backgroundColor: "#0a0a0a", border: "1px solid #1e1e1e", borderRadius: "4px", boxShadow: "0 2px 8px rgba(0,0,0,0.6)", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace' },
  ".cm-textfield": { height: "22px", padding: "0 6px", backgroundColor: "#050505", color: "#cccccc", border: "1px solid #1e1e1e", borderRadius: "3px", fontSize: "12px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', outline: "none", minWidth: "120px", width: "120px" },
  ".cm-textfield:focus": { borderColor: "#00d4aa" },
  ".cm-search .cm-button": { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", padding: "0", border: "none", borderRadius: "3px", backgroundColor: "transparent", backgroundImage: "none", color: "#333333", cursor: "pointer", flexShrink: "0" },
  ".cm-search .cm-button:hover": { color: "#00d4aa", backgroundColor: "#111111" },
  ".cm-search label": { display: "inline-flex", alignItems: "center", gap: "3px", fontSize: "11px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', color: "#333333", cursor: "pointer", userSelect: "none" },
  ".cm-search input[type=checkbox]": { accentColor: "#00d4aa", width: "11px", height: "11px", margin: "0", cursor: "pointer" },
  ".cm-search .cm-search-match-count": { fontSize: "11px", color: "#333333", padding: "0 4px" },
...
const dawnTheme = EditorView.theme({
  ...
  ".cm-panels.cm-panels-top": { position: "absolute", top: "4px", right: "4px", left: "auto", width: "auto", zIndex: "10", borderTop: "none", backgroundColor: "transparent", padding: "0" },
  ".cm-panels": { backgroundColor: "transparent", padding: "0" },
  ".cm-search": { display: "flex", alignItems: "center", flexWrap: "wrap", gap: "2px", padding: "4px 6px", backgroundColor: "#e8e8f0", border: "1px solid #d0d0de", borderRadius: "4px", boxShadow: "0 2px 8px rgba(0,0,0,0.15)", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace' },
  ".cm-textfield": { height: "22px", padding: "0 6px", backgroundColor: "#ffffff", color: "#1a1a3a", border: "1px solid #d0d0de", borderRadius: "3px", fontSize: "12px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', outline: "none", minWidth: "120px", width: "120px" },
  ".cm-textfield:focus": { borderColor: "#3878e8" },
  ".cm-search .cm-button": { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", padding: "0", border: "none", borderRadius: "3px", backgroundColor: "transparent", backgroundImage: "none", color: "#9898b8", cursor: "pointer", flexShrink: "0" },
  ".cm-search .cm-button:hover": { color: "#3878e8", backgroundColor: "#ebebf2" },
  ".cm-search label": { display: "inline-flex", alignItems: "center", gap: "3px", fontSize: "11px", fontFamily: '"JetBrains Mono","Cascadia Code",Menlo,monospace', color: "#9898b8", cursor: "pointer", userSelect: "none" },
  ".cm-search input[type=checkbox]": { accentColor: "#3878e8", width: "11px", height: "11px", margin: "0", cursor: "pointer" },
  ".cm-search .cm-search-match-count": { fontSize: "11px", color: "#9898b8", padding: "0 4px" },
